...
@section('content')
    Dear {{ $firstname . ' ' . $lastname }},<br /><br /> <a href="#">Freightos.com</a> has partnered with Clearit to offer a frictionless digital customs experience. Please be sure to monitor your emails for further communications. <br /><br />
    Please be advised that the following tariff codes have been attached to your shipment {{ $affiliateReferenceNumber }}<br />
