  ...
  <div class="auth-wrapper auth-v2">
    <b-row class="auth-inner m-0">
      ...
      <b-link class="brand-logo">
        <!-- <vuexy-logo /> -->
        <clearit-logo />
        <!-- <h2 class="brand-text text-primary ml-1">Clearit</h2> -->
      </b-link>
      <!-- /Brand logo-->
      ...
      <b-col lg="4" class="d-flex align-items-center auth-bg px-2 p-lg-5">
        <b-col sm="8" md="6" lg="12" class="px-xl-2 mx-auto">
          <b-card-title class="mb-1 font-weight-bold" title-tag="h2"> Welcome to Clearit! 👋 </b-card-title>
...
import ClearitLogo from '@/components/ClearitLogo.vue'
...
export default {
  ...
  methods: {
    ...mapActions('auth', { jwtLogin: 'login' }),
    async login() {
      try {
