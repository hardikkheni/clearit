<template>
  <div class="ticket-collapse prekey-role">
    <app-collapse accordion type="margin">
      <app-collapse-item ref="collapseItem" class="outline-secondary" title="">
        <template #header>
          <span class="lead collapse-title">Pre-keying & Billing</span>
        ...
        <freightos-final-billing
          v-if="isFreightosTicket"
          :ticket-id="getFullTicket.ticketId || 0"
          :freight-invoice-docs="freightInvoiceDocs"
        />
      </app-collapse-item>
    </app-collapse>
  </div>
...
import FreightosFinalBilling from '@/views/ticket/components/role-ticket/FreightOSFinalBilling.vue'
