<template>
  <div class="ticket-collapse arrival-notice-role">
    <app-collapse accordion type="margin">
      <app-collapse-item ref="collapseItem" class="outline-secondary" title="">
        <template #header>
          <span class="lead collapse-title">Arrival Notice and Release</span>
        ...
        <release-tracking :get-full-ticket="getFullTicket || {}" />
      </app-collapse-item>
    </app-collapse>
  </div>
</template>
...
import ReleaseTracking from '@/views/ticket/components/role-ticket/ReleaseTracking.vue'
