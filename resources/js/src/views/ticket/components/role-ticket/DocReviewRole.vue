<template>
  <div class="ticket-collapse doc-review-role">
    <app-collapse accordion type="margin">
      <app-collapse-item ref="collapseItem" class="outline-secondary" title="">
        <template #header>
          <span class="lead collapse-title">Doc Review & Tariff Code Assignment</span>
        ...
        <ticket-htsr :get-full-ticket="getFullTicket || {}" :role="role" :hts-codes="htsCodes" :ticket="ticket" />
      </app-collapse-item>
    </app-collapse>
  </div>
</template>
...
import TicketHtsr from '@/views/ticket/components/role-ticket/TicketHTSR.vue'
